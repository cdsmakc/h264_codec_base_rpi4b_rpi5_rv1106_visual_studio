...
INT __RCE_ParseConfig(VOID)
{
    ...
    strcpy(g_stRCEConfig.acPreset, iniparser_getstring(pstDictionary, "ENCODER_CFG:encoder_cfg_preset", RCE_ENCODER_PRESET)) ;
    strcpy(g_stRCEConfig.acProfile, iniparser_getstring(pstDictionary, "ENCODER_CFG:encodef_cfg_profile", RCE_ENCODER_PROFILE)) ;
...
VOID __RCE_DumpConfig(VOID)
{
    ...
    printf("** CFG : ************************\n"
            ...
            g_stRCEConfig.uiFps,
            g_stRCEConfig.acPreset,
            g_stRCEConfig.acProfile,
